  ...
  return (
    <div className="min-h-screen bg-background flex flex-col justify-center px-margin-mobile">
      <div className="max-w-[400px] w-full mx-auto flex flex-col gap-lg">
        ...
        {success ? (
          <div className="bg-surface-container-lowest border-[0.5px] border-outline-variant rounded-xl p-6 flex flex-col gap-4 shadow-sm text-center">
          ...
          <form onSubmit={handleRegister} className="bg-surface-container-lowest border-[0.5px] border-outline-variant rounded-xl p-6 flex flex-col gap-4 shadow-sm">
            {error && (
            ...
            >
              {loading ? <span className="material-symbols-outlined animate-spin text-[18px]">sync</span> : 'Sign Up'}
            </button>
