  ...
  return (
    <div className="px-margin-mobile pt-lg flex flex-col gap-6 md:px-margin-desktop">
      ...
      <div className="flex flex-col gap-1">
        <h1 className="font-headline-md text-headline-md text-on-surface font-bold">Welcome back, Developer</h1>
        <p className="font-body-md text-body-md text-on-surface-variant font-bold">Ready to refine your technical communication today?</p>
      </div>
      ...
      <section className="bg-surface-container-lowest dark:bg-surface-container border-[0.5px] border-outline-variant dark:border-outline rounded-xl p-4 flex flex-col gap-4">
        <div className="flex justify-between items-start">
          <div className="flex flex-col gap-1">
            ...
            <span className="font-headline-lg text-headline-lg-mobile text-on-surface font-code-inline">{isLoading ? '-' : stats.weeklySessions}</span>
          </div>
          <div className="flex items-center gap-1 bg-surface-container-low border-[0.5px] border-outline-variant rounded-lg px-2 py-1">
            ...
            <span className="font-label-md text-label-md text-primary">{isLoading ? '-' : stats.streak} Day Streak</span>
          </div>
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-2">
            <span className="font-code-inline text-code-inline text-on-surface">{isLoading ? '-' : `${stats.averageClarity}%`}</span>
      ...
      {/* Module Grid */}
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pb-32">
        <Link to="/dsa-simulator" className="bg-surface-container-lowest dark:bg-surface border-[0.5px] border-outline-variant dark:border-outline rounded-xl p-4 flex flex-col gap-3 items-start text-left hover:bg-surface-container-low transition-colors active:opacity-80">
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="font-body-md text-[12px] leading-tight text-on-surface-variant">Technical Interview</p>
          </div>
        </Link>

        <Link to="/custom-simulator" className="bg-surface-container-lowest dark:bg-surface border-[0.5px] border-outline-variant dark:border-outline rounded-xl p-4 flex flex-col gap-3 items-start text-left hover:bg-surface-container-low transition-colors active:opacity-80">
          <div className="w-10 h-10 rounded-lg bg-primary-container/10 border-[0.5px] border-primary-container/20 flex items-center justify-center">
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="font-body-md text-[12px] leading-tight text-on-surface-variant">Any Topic</p>
          </div>
        </Link>
        ...
        <Link to="/analysis" className="bg-surface-container-lowest dark:bg-surface border-[0.5px] border-outline-variant dark:border-outline rounded-xl p-4 flex flex-col gap-3 items-start text-left hover:bg-surface-container-low transition-colors active:opacity-80">
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="font-body-md text-[12px] leading-tight text-on-surface-variant">Speech & Grammar</p>
          </div>
        </Link>

        <Link to="/vocab-builder" className="bg-surface-container-lowest dark:bg-surface border-[0.5px] border-outline-variant dark:border-outline rounded-xl p-4 flex flex-col gap-3 items-start text-left hover:bg-surface-container-low transition-colors active:opacity-80">
          <div className="w-10 h-10 rounded-lg bg-surface-container border-[0.5px] border-outline-variant flex items-center justify-center">
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="font-body-md text-[12px] leading-tight text-on-surface-variant">Learn from mistakes</p>
          </div>
        </Link>
      </section>
      ...
      <div className="fixed bottom-[96px] left-margin-mobile right-margin-mobile z-40 max-w-[1200px] mx-auto md:w-[calc(100%-64px)] w-[calc(100%-32px)]">
        <Link to="/custom-simulator" className="w-full bg-primary-container text-on-primary-container rounded-xl p-4 flex items-center justify-between active:scale-[0.98] transition-transform shadow-none border-[0.5px] border-primary-container">
          <div className="flex flex-col items-start">
            <span className="font-label-md text-[12px] opacity-80 uppercase tracking-widest">Continue</span>
            <span className="font-label-md text-label-md font-bold mt-0.5">Start Custom Interview</span>
          </div>
